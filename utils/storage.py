...
def _default_guild() -> dict:
    return {
        ...
        "wheel": {
            "prize_room_id": None,   # قناة الإعلان عن جوائز عجلة الحظ
            "invite_room_id": None,  # قناة سجل الدعوات (نقاط)
            "points": {},            # {user_id: points}
            "seen_members": {},      # {member_id: true} - لمنع تكرار احتساب نفس العضو لو طلع ودخل
        },
        "security": {
            "bot_add": {
                "allowed_role_id": None,
